...
public class TtripHotelRoom {
    ...
    public TtripHotelRoom(Long id, Long hotelid, String roomtitle, BigDecimal roomprice, Long roombedtypeid, Integer ishavingbreakfast, Integer paytype, Long satisfaction, Integer isbook, Integer iscancel, Integer istimelyresponse, Date creationdate, Long createdby, Date modifydate, Long modifiedby) {
        this.id = id;
